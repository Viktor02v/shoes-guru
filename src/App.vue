...
<template>
	<div id="TopNav" class="relative z-30 flex items-center justify-between w-[100%] h-[74px]">
		<div  class="fixed  bg-[#F8F9F9] flex items-center  w-[100%] h-[74px] justify-between px-20">
			<div class="flex items-center ">
				...
				<div class="w-full ml-3">
					...
					<p class="font-light text-gray-500 text-sm ">Become a shoes guru</p>
				</div>
			</div>
			...
			<div class="flex items-center">
				<ul class="flex items-center  gap-12">
					<RouterLink to="/man">
						<li class="font-semibold text-md cursor-pointer ">FOR MEN</li>
					</RouterLink>
					<RouterLink to="/woman">
						<li class="font-semibold text-md border-l border-l-[#32323D] pl-[35px] cursor-pointer ">FOR WOMEN</li>
					</RouterLink>
					<RouterLink to="/children">
						<li class="font-semibold text-md border-l border-l-[#32323D] pl-[35px] cursor-pointer ">FOR CHILDREN
						</li>
					</RouterLink>
				</ul>
			</div>
