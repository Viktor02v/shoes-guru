...
import SliderItemChild from '@/components/SliderItemWomen.vue';
...
<template>
	<div class="w-full">
		<div class="flex justify-between items-center mb-4">
			...
			<h2 class="font-extrabold ml-1.5 text-[25px] uppercase">Nike && Jordan Essentials For Child</h2>
